...
data class ForecastDayResponse(
    ...
    @Json(name = "hour") val hour: List<ForecastHourResponse>? = null
)
...
data class ForecastHourResponse(
    ...
    @Json(name = "cloud") val cloud: Double? = null,
    ...
    @Json(name = "heatindex_c") val heatindexC: Double? = null,
    @Json(name = "heatindex_f") val heatindexF: Double? = null,
    @Json(name = "dewpoint_c") val dewpointC: Double? = null,
    @Json(name = "dewpoint_f") val dewpointF: Double? = null,
    ...
    @Json(name = "chance_of_snow") val chanceOfSnow: Double? = null,
    @Json(name = "vis_km") val visKm: Double? = null,
    @Json(name = "vis_miles") val visMiles: Double? = null,
